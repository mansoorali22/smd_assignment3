...
// Add a ValueEventListener to listen for changes in the Commchat node
        ...
        val messagebar = findViewById<LinearLayout>(R.id.messageview)
        ...
        rootView.viewTreeObserver.addOnGlobalLayoutListener(object : ViewTreeObserver.OnGlobalLayoutListener {
            override fun onGlobalLayout() {
                ...
                if (keypadHeight > screenHeight * 0.15) { // Keyboard is open
                    ...
                    messagebar.layoutParams.height = ViewGroup.LayoutParams.WRAP_CONTENT
...
////////////////////////////////////////////////////////////////////////////////
    ...
    private fun startRecording() {
        ...
        recorder = MediaRecorder().apply {
            ...
            try {
                ...
                Toast.makeText(this@page13_Activity_chat3, "Audio Recording", Toast.LENGTH_SHORT).show()
            } catch (e: Exception) {
    ...
    private fun stopRecording() {
        recorder?.apply {
            try {
                ...
                Toast.makeText(this@page13_Activity_chat3, "Recording Stops", Toast.LENGTH_SHORT).show()
    ...
    private fun uploadAudioToFirebase() {
        ...
        storageRef.putFile(file, StorageMetadata.Builder()
            ...
            .addOnSuccessListener { taskSnapshot ->
                ...
                taskSnapshot.storage.downloadUrl.addOnSuccessListener { uri ->
                    ...
                    Log.d("My audio", "Audio uploaded to Firebase Storage. Download URL: $downloadUrl")
    ...
    private fun sendMessage(receiverID: String,type:Int, messageuri:String) {
        ...
        val assignAnID = receiverID

        val database = FirebaseDatabase.getInstance().getReference("Commchat").child(assignAnID)
        val messageId = database.push().key // Generate a unique key for the message
        if (msgid=="") {
            var chat=CommchatMessageModel("","", "", "","","","","","1")
            if (type==1) {
                chat = CommchatMessageModel(messageId!!,  user, time, "", msg.text.toString(), "", "", "", "1")
                sendNotification(msg.text.toString())

            }
            else if(type==2) {
                chat = CommchatMessageModel(messageId!!, user, time, "", "", messageuri, "", "", "2")
    ...
    private fun LoadMsg(userID: String){
        ...
        var chatlist=ArrayList<CommchatMessageModel>()
        //chatlist.clear()
                ...
                for (userSnapshot in snapshot.children) {
                    ...
                    if(userID==userID2) {
                        for (chatSnapshot in userSnapshot.children) {
                            ...
                            val booking = CommchatMessageModel(messgid!!,mentor!!, time!!, uri ,tmsg.toString(),audio.toString(),pic.toString(),"",type.toString())
    ...
    @SuppressLint("MissingInflatedId")
    private fun chatMentor(chatlist: MutableList<CommchatMessageModel>, chatid:String){
        ...
        for (chat in chatlist) {
            if (chat.id==user) {        //for sent messages
                ...
                del.setOnClickListener {
                    ...
                    del.text=""
                    msg.text=""
                    val database = FirebaseDatabase.getInstance().getReference("Commchat")
    ...
    private fun sendNotificationToOtherUser(username: String, othertoken: String, message: String) {
        try {
            ...
            notificationObj.put("title", username+" in group chat")
